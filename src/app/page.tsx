...
const GallerySection = dynamic(() => import("@/components/homepage/GallerySection"), { ssr: false, loading: () => <HomeSkeleton section="gallery" /> });
...
function HomeSkeleton({ section }: { section: string }) {
  ...
  if (section === "gallery") height = "h-56 md:h-72";
...
export default function Home() {
  return (
    <main className="px-3 pt-3 md:p-0">
      ...
      <Suspense fallback={<HomeSkeleton section="gallery" />}> <GallerySection /> </Suspense>
